        ...
        private void relax(EdgeWeightedDigraph G, int v) 
        {
        	...
        	for(DirectedEdge e: G.adj(v)) {
        		...
        		if(distTo[w]>distTo[v]+e.weight()) {
        			...
        			edgeTo[w] = e;
        			if(minPQ.contains(w)) minPQ.decreaseKey(w, distTo[w]);
...
//            return 0.0;
        ...
        public boolean hasPathToTarget() 
        {
        	// TODO
//            return false;
        	return distTo[this.target]<Double.POSITIVE_INFINITY;
        }
        ...
        public Iterable<DirectedEdge> pathToTarget() 
        {
            ...
            {
                // TODO
            	for(DirectedEdge e=edgeTo[this.target];e!=null;e = edgeTo[e.from()])
            		path.push(e);
            }
