...
//			return 1293879128;
			...
			res = 37*res + ((Integer)this.age).hashCode();
			return res;
		}
	...
	public void addPerson (Person p) {
		// TODO
		if(p==null || map.get(p)!=null) return;
	...
	public void addFriendship (Person p1, Person p2) {
		// TODO
		if(p1==null || p2==null || p1.equals(p2) || map.get(p1)==null || map.get(p2)==null || map.get(p1).contains(p2)) return;
		map.get(p1).add(p2);
		map.get(p2).add(p1);
	...
	public void removeFriendship (Person p1, Person p2) {
		// TODO
		if(p1==null || p2==null || map.get(p1)==null || map.get(p2)==null || !map.get(p1).contains(p2)) return;
	...
	public boolean queryFriendship (Person p1, Person p2) {
		...
		// TODO
//		return false;
		return (p1!=null && p2!=null && map.get(p1)!=null && map.get(p1).contains(p2));
	}
