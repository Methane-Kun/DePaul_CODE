...
//    throw UnsupportedOperationException()
  ...
  def joinTerminateRight(xs: List[String], term: String): String =
    foldRight(xs,"",(e:String,x:String) => e+term+x)
    // TODO: Provide definition here.
//    throw UnsupportedOperationException()
  ...
  def joinTerminateLeft(xs: List[String], term: String): String =
    foldLeft(xs,"",(e:String,x:String) => e+x+term)
    // TODO: Provide definition here.
//    throw UnsupportedOperationException()
  ...
  def firstNumGreaterOrEqual(a: Int, xs: List[Int]): Int =
    xs match
      ...
      case y::_ if(y >= a) => y
      case _::ys => firstNumGreaterOrEqual(a,ys)
    // TODO: Provide definition here.
//    throw UnsupportedOperationException()
  ...
  def firstIndexNumGreaterOrEqual(a: Int, xs: List[Int]): Int =
    firstIndexNumGreaterOrEqualAux(a, xs, 0)
    // TODO: Provide definition here.
//    throw UnsupportedOperationException()

  def firstIndexNumGreaterOrEqualAux(a: Int, xs: List[Int], index: Int): Int =
    xs match
      case Nil => throw java.util.NoSuchElementException()
      case y::_ if(y>=a) => index
      case _::ys => firstIndexNumGreaterOrEqualAux(a,ys,index+1)
