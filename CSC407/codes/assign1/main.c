 ...
 * @version: 
 * @Author: Kun Shan
 * @Date: 2023-01-11 19:34:10
 * @LastEditors: Kun Shan
 * @LastEditTime: 2023-01-15 15:48:02
 * @FilePath: /codes/assign1/main.c
 */
/*-------------------------------------------------------------------------*
 *---									---*
 *---		main.c							---*
...
char**		generateStringArray (int	numStrings)
{
...
void		print	(char**		array, int		arrayLen)
{
  int	i;
  int	j;
...
void		releaseMem	(char**		array, int		arrayLen)
{
  int	i;
